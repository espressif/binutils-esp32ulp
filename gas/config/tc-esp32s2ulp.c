...
// This variable will be used to define command set for sifferent CPU types for the ULP 
...
{
//	printf("md_parse_option: c = %i, OPTION_MCPU = %i, arg - %s\n", c, OPTION_MCPU, arg);
	switch (c)
	{
	default:
		ulp_cpu_type = 0;
...
int esp32s2ulp_force_relocation(struct fix *fixp)
{
...
bfd_boolean esp32s2ulp_eol_in_insn(char *line)
{
