...
#ifndef ESP32S2ULP_PARSE_H
#define ESP32S2ULP_PARSE_H
...
struct esp32s2ulp_insn
{
	unsigned long value;
	struct esp32s2ulp_insn *next;
...
#define INSTR_T struct esp32s2ulp_insn*
